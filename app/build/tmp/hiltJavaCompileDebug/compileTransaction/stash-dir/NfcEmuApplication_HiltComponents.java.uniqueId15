...
import com.nfcemu.di.CoroutineModule;
import com.nfcemu.di.DataStoreModule;
...
public final class NfcEmuApplication_HiltComponents {
  private NfcEmuApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements NfcEmuApplication_GeneratedInjector,
  ...
  @Subcomponent
  @ServiceScoped
  public abstract static class ServiceC implements NfcEmuHostApduService_GeneratedInjector,
      ServiceComponent,
      GeneratedComponent {
